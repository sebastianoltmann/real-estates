                ...
                <section class="mobileversion">
                    ...
                    <ul class="residences">
                        <li class="marker p7" data-coordinates="757,314">
                            <a href="{{ url('de/page/penthouse7') }}" class="plus plus-white" title="Penthouse7"><i>+</i></a>
                        </li>
                        <li class="marker p6" data-coordinates="737,524">
                            <a href="{{ url('de/page/residence6') }}" class="plus plus-white" title="Residence6"><i>+</i></a>
                        </li>
                        <li class="marker p5" data-coordinates="828,854">
                            <a href="{{ url('de/page/residence5') }}" class="plus plus-white" title="Residence5"><i>+</i></a>
                        </li>
                        <li class="marker p4" data-coordinates="828,854">
                            <a href="{{ url('de/page/residence4') }}" class="plus plus-white" title="Residence4"><i>+</i></a>
                        </li>
                        <li class="marker p3" data-coordinates="828,854">
                            <a href="{{ url('de/page/residence3') }}" class="plus plus-white" title="Residence3"><i>+</i></a>
                        </li>
                        <li class="marker p2" data-coordinates="828,854">
                            <a href="{{ url('de/page/residence2') }}" class="plus plus-white" title="Residence2"><i>+</i></a>
                        </li>
                        <li class="marker p1" data-coordinates="828,854" >
                            <a href="{{ url('de/page/residence1') }}" class="plus plus-white" title="Residence1"><i>+</i></a>
                        </li>
                    </ul>
                </section>
