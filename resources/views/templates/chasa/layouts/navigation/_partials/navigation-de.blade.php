...
<div id="menu" @if(request()->routeIs('pages.index'))style="display: none" @endif>
    ...
    <nav
        ...
        <a class="navbar-brand"
           href="{{ request()->routeIs('pages.index') ? url('de/page/7-objectsDart') : route('pages.index') }}">
            <img src="{{ asset('/themes/chasa/assets/img/ChasaChau-Logo.png') }}"
        ...
        <div class="welcome-left animated bounce @if(!request()->routeIs('pages.index'))d-none d-lg-block @endif">
            <ul class="navbar-nav flex-column ml-5">
                <li class="nav-item">
                    <x-jet-nav-link href="{{ url('de/page/7-objectsDart') }}"
                                    :active="request()->is('de/page/7-objectsDart')">
                        {{ __("7 Objects D'art") }}
                    </x-jet-nav-link>
                    @if(request()->is('de/page/7-objectsDart', 'de/page/welcome'))
                        <x-jet-nav-link href="{{ url('de/page/welcome') }}"
                                        :active="request()->is('de/page/welcome')">
                            {{ __('Herzlich Wilkommen') }}
                        </x-jet-nav-link>
                    @endif
                </li>
            </ul>
        ...
        @if(!request()->routeIs('pages.index'))
            <div class="navbar-collapse collapse justify-content-end animated bounceIn" id="collapsingNavbar">
                <ul class="navbar-nav">
                    ...
                    <x-jet-nav-link href="{{ url('de/page/secret') }}"
                                    :active="request()->is('de/page/secret')">
                        {{ __('Geheimtipp') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ url('de/page/history') }}"
                                    :active="request()->is('de/page/history')">
                        {{ __('Geschichte') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ url('de/page/vivre-a-la-carte') }}"
                                    :active="request()->is('de/page/vivre-a-la-carte')">
                        {{ __('Vivre a la carte') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ url('de/page/gallery') }}"
                                    :active="request()->is('de/page/gallery')">
                        {{ __('Residenz') }}
                    </x-jet-nav-link>
                </ul>
            </div>
        ...
        @if(!request()->routeIs('pages.index'))
            <div class="nav navbar-nav flex-column animated bounceIn ml-auto ml-lg-0">
                ...
                <ul class="navbar-nav">
                    ...
                    <x-jet-nav-link href="{{ url('de/page/contact') }}"
                                    :active="request()->is('de/page/contact')">
